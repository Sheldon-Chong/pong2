...
export class Arrow extends GameObject {
    ...
    Draw() {
        ...
        this.sprite.drawImg(this.ctx, new Point2D(x, this.position.y - this.game.camera.position.y + this.parent.position.y + this.game.canvasSize.y / 2), this.sprite.size, 0);
    }
}
